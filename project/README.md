...
Additionally, we've put some of the top projects from previous semesters in [a drive folder](https://drive.google.com/drive/folders/notyet).  The folder and its contents are available for viewing to anyone with a berkeley.edu email address.
...
Please write your proposal in a Google Doc (shared with comment access to anyone with the link) and submit a link to you proposal via [this form](https://forms.gle/wait).  We'll provide feedback as in-line comments, which can be more convenient than an email thread.
...
Please submit your PDF (and your project's code) to your course GitHub if working alone or to a team repo if in a group and then complete [this form](https://forms.gle/notyet).
